"""
pytest data/app_data/10-systems-performance/04-compression/03-knowledge-distillation/tests.py
"""
...
distillation_loss = load_solution(
    f"10-systems-performance/04-compression/{Path(__file__).resolve().parent.name}"
).distillation_loss

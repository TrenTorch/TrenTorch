"""
pytest data/app_data/10-systems-performance/04-compression/01-magnitude-pruning/tests.py
"""
...
magnitude_prune = load_solution(f"10-systems-performance/04-compression/{Path(__file__).resolve().parent.name}").magnitude_prune

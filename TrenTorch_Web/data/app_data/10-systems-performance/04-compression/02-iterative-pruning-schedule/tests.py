"""
pytest data/app_data/10-systems-performance/04-compression/02-iterative-pruning-schedule/tests.py
"""
...
_module = load_solution(f"10-systems-performance/04-compression/{Path(__file__).resolve().parent.name}")

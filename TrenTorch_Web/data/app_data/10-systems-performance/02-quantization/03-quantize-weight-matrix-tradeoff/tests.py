"""
pytest data/app_data/10-systems-performance/02-quantization/03-quantize-weight-matrix-tradeoff/tests.py
"""
...
quantize_weight_matrix = load_solution(
    f"10-systems-performance/02-quantization/{Path(__file__).resolve().parent.name}"

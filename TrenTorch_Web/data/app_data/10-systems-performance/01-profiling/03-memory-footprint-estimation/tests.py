"""
pytest data/app_data/10-systems-performance/01-profiling/03-memory-footprint-estimation/tests.py
"""
...
_module = load_solution(f"10-systems-performance/01-profiling/{Path(__file__).resolve().parent.name}")

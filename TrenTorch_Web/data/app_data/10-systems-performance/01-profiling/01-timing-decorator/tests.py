"""
pytest data/app_data/10-systems-performance/01-profiling/01-timing-decorator/tests.py
"""
...
timed = load_solution(f"10-systems-performance/01-profiling/{Path(__file__).resolve().parent.name}").timed

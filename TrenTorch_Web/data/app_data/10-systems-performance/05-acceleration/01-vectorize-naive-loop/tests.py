"""
pytest data/app_data/10-systems-performance/05-acceleration/01-vectorize-naive-loop/tests.py
"""
...
_module = load_solution(f"10-systems-performance/05-acceleration/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/10-systems-performance/03-mixed-precision-training/01-fp16-bf16-representable-range/tests.py
"""
...
_module = load_solution(f"10-systems-performance/03-mixed-precision-training/{Path(__file__).resolve().parent.name}")

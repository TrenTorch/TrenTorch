"""
pytest data/app_data/10-systems-performance/06-kernels/04-torch-compile-graph-compilation/tests.py
"""
...
_module = load_solution(f"10-systems-performance/06-kernels/{Path(__file__).resolve().parent.name}")
...
unfused_memory_traffic = load_solution("10-systems-performance/06-kernels/01-kernel-fusion").unfused_memory_traffic
fused_memory_traffic = load_solution("10-systems-performance/06-kernels/01-kernel-fusion").fused_memory_traffic

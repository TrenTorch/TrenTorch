...
A view keeps the buffer plus a `range` of buffer positions — element `i` of the view is `buffer[indices[i]]`, and slicing the view slices `indices`, producing another view of the _same_ buffer.

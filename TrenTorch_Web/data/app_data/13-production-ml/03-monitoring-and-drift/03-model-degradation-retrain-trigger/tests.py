"""
pytest data/app_data/13-production-ml/03-monitoring-and-drift/03-model-degradation-retrain-trigger/tests.py
"""
...
_module = load_solution(f"13-production-ml/03-monitoring-and-drift/{Path(__file__).resolve().parent.name}")

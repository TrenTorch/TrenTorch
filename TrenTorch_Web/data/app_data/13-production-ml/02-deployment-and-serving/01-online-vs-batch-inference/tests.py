"""
pytest data/app_data/13-production-ml/02-deployment-and-serving/01-online-vs-batch-inference/tests.py
"""
...
_module = load_solution(f"13-production-ml/02-deployment-and-serving/{Path(__file__).resolve().parent.name}")

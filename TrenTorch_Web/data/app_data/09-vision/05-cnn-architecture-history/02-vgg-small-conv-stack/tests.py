"""
pytest data/app_data/09-vision/05-cnn-architecture-history/02-vgg-small-conv-stack/tests.py
"""
...
vgg_stack = load_solution(
    f"09-vision/05-cnn-architecture-history/{Path(__file__).resolve().parent.name}"
).vgg_stack
conv2d_multi_filter = load_solution("09-vision/01-convolutions/05-multiple-output-filters").conv2d_multi_filter

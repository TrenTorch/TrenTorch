"""
pytest data/app_data/09-vision/05-cnn-architecture-history/06-feature-pyramid-merge/tests.py
"""
...
_module = load_solution(f"09-vision/05-cnn-architecture-history/{Path(__file__).resolve().parent.name}")

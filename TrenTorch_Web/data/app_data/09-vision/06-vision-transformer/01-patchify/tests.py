"""
pytest data/app_data/09-vision/06-vision-transformer/01-patchify/tests.py
"""
...
patchify = load_solution(f"09-vision/06-vision-transformer/{Path(__file__).resolve().parent.name}").patchify

"""
pytest data/app_data/09-vision/06-vision-transformer/04-vit-encoder-block/tests.py
"""
...
vit_encoder_block = load_solution(
    f"09-vision/06-vision-transformer/{Path(__file__).resolve().parent.name}"
).vit_encoder_block
...
def test_08_underlying_transformer_block_is_the_same_already_torch_verified_implementation():
    ...
    # itself (07-transformers-llm/01-transformer-block/06-assemble-full-

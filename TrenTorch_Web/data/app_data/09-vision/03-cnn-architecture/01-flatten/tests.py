"""
pytest data/app_data/09-vision/03-cnn-architecture/01-flatten/tests.py
"""
...
flatten = load_solution(f"09-vision/03-cnn-architecture/{Path(__file__).resolve().parent.name}").flatten

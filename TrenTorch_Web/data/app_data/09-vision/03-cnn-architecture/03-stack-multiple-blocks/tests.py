"""
pytest data/app_data/09-vision/03-cnn-architecture/03-stack-multiple-blocks/tests.py
"""
...
cnn_block = load_solution("09-vision/03-cnn-architecture/02-one-cnn-block").cnn_block

"""
pytest data/app_data/09-vision/01-convolutions/05-multiple-output-filters/tests.py
"""
...
conv2d_multi_filter = load_solution(
    f"09-vision/01-convolutions/{Path(__file__).resolve().parent.name}"
).conv2d_multi_filter
conv2d_multi_channel = load_solution(
    "09-vision/01-convolutions/04-multi-channel-input"

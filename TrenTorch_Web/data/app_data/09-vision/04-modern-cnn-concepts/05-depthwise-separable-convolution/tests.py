"""
pytest data/app_data/09-vision/04-modern-cnn-concepts/05-depthwise-separable-convolution/tests.py
"""
...
depthwise_separable_conv2d = load_solution(
    f"09-vision/04-modern-cnn-concepts/{Path(__file__).resolve().parent.name}"
).depthwise_separable_conv2d
conv2d_single_filter = load_solution("09-vision/01-convolutions/01-single-filter-conv2d").conv2d_single_filter
pointwise_conv = load_solution("09-vision/04-modern-cnn-concepts/03-1x1-convolution").pointwise_conv

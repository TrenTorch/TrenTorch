"""
pytest data/app_data/09-vision/02-pooling/03-adaptive-average-pooling/tests.py
"""
...
adaptive_avg_pool2d = load_solution(
    f"09-vision/02-pooling/{Path(__file__).resolve().parent.name}"
).adaptive_avg_pool2d
...
def test_03_evenly_dividing_output_size_matches_plain_average_pooling():
    ...
    avg_pool2d = load_solution("09-vision/02-pooling/02-average-pooling").avg_pool2d

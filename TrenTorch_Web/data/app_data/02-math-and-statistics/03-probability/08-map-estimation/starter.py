...
normal_pdf = load_solution("02-math-and-statistics/03-probability/06-likelihood-vs-probability").normal_pdf
negative_log_likelihood_normal = load_solution(
    "02-math-and-statistics/03-probability/07-maximum-likelihood-estimation"

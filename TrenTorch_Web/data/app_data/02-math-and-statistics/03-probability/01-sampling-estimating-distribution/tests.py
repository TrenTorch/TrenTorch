"""
pytest data/app_data/02-math-and-statistics/03-probability/01-sampling-estimating-distribution/tests.py
"""
...
_module = load_solution(f"02-math-and-statistics/03-probability/{Path(__file__).resolve().parent.name}")

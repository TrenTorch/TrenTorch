"""
pytest data/app_data/02-math-and-statistics/06-exploratory-data-analysis/05-feature-engineering/tests.py
"""
...
_module = load_solution(
    f"02-math-and-statistics/06-exploratory-data-analysis/{Path(__file__).resolve().parent.name}"
)
radius_feature = _module.radius_feature
ratio_feature = _module.ratio_feature

correlation = load_solution("02-math-and-statistics/03-probability/03-covariance-correlation").correlation

"""
pytest data/app_data/02-math-and-statistics/01-linear-algebra/08-positive-definite-matrices/tests.py
"""
...
_module = load_solution(
    f"02-math-and-statistics/01-linear-algebra/{Path(__file__).resolve().parent.name}"
)

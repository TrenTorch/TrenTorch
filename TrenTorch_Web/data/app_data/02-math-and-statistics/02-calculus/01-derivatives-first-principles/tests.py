"""
pytest data/app_data/02-math-and-statistics/02-calculus/01-derivatives-first-principles/tests.py
"""
...
_module = load_solution(f"02-math-and-statistics/02-calculus/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/02-math-and-statistics/04-information-theory/04-mutual-information/tests.py
"""
...
_module = load_solution(f"02-math-and-statistics/04-information-theory/{Path(__file__).resolve().parent.name}")
...
def test_mutual_information_of_perfectly_determined_relationship_equals_entropy():
    ...
    entropy = load_solution("02-math-and-statistics/04-information-theory/01-entropy").entropy
    px = joint.sum(axis=1)

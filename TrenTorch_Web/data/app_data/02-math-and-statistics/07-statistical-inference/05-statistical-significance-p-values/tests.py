"""
pytest data/app_data/02-math-and-statistics/07-statistical-inference/05-statistical-significance-p-values/tests.py
"""
...
_module = load_solution(
    f"02-math-and-statistics/07-statistical-inference/{Path(__file__).resolve().parent.name}"
)
...
two_sample_t_test = load_solution(
    "02-math-and-statistics/07-statistical-inference/03-hypothesis-testing-t-test"
).two_sample_t_test

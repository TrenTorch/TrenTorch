"""
pytest data/app_data/02-math-and-statistics/05-data-preprocessing/01-detecting-missing-values/tests.py
"""
...
_module = load_solution(
    f"02-math-and-statistics/05-data-preprocessing/{Path(__file__).resolve().parent.name}"
)

"""
pytest data/app_data/03-classical-ml/03-decision-trees/04-pruning/tests.py
"""
...
_module = load_solution(f"03-classical-ml/03-decision-trees/{Path(__file__).resolve().parent.name}")

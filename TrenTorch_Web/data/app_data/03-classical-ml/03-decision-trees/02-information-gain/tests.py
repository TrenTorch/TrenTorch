"""
pytest data/app_data/03-classical-ml/03-decision-trees/02-information-gain/tests.py
"""
...
information_gain = load_solution(
    f"03-classical-ml/03-decision-trees/{Path(__file__).resolve().parent.name}"
).information_gain
gini_impurity = load_solution("03-classical-ml/03-decision-trees/01-gini-impurity").gini_impurity

"""
pytest data/app_data/03-classical-ml/08-tabular-foundation-models/03-two-way-attention-block/tests.py
"""
...
two_way_attention_block = load_solution(
    f"03-classical-ml/08-tabular-foundation-models/{Path(__file__).resolve().parent.name}"
).two_way_attention_block
row_wise_attention = load_solution(
    "03-classical-ml/08-tabular-foundation-models/01-row-wise-attention"
).row_wise_attention
column_wise_attention = load_solution(
    "03-classical-ml/08-tabular-foundation-models/02-column-wise-attention"

"""
pytest data/app_data/03-classical-ml/08-tabular-foundation-models/04-in-context-prediction/tests.py
"""
...
two_way_attention_block = load_solution(
    "03-classical-ml/08-tabular-foundation-models/03-two-way-attention-block"

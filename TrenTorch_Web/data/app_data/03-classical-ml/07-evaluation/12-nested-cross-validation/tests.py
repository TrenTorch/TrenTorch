"""
pytest data/app_data/03-classical-ml/07-evaluation/12-nested-cross-validation/tests.py
"""
...
nested_cross_validation = load_solution(
    f"03-classical-ml/07-evaluation/{Path(__file__).resolve().parent.name}"
).nested_cross_validation
grid_search = load_solution("03-classical-ml/07-evaluation/04-grid-search").grid_search
k_fold_split = load_solution(
    "03-classical-ml/07-evaluation/01-splitting-and-resampling"
).k_fold_split
knn_predict = load_solution("03-classical-ml/05-instance-based-probabilistic/01-knn").knn_predict

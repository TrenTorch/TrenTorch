"""
pytest data/app_data/03-classical-ml/07-evaluation/11-threshold-optimization/tests.py
"""
...
_module = load_solution(f"03-classical-ml/07-evaluation/{Path(__file__).resolve().parent.name}")
f1_metric = _module.f1_metric
optimize_threshold = _module.optimize_threshold
precision_recall_f1 = load_solution(
    "03-classical-ml/07-evaluation/02-classification-metrics"
).precision_recall_f1

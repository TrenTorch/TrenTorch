"""
pytest data/app_data/03-classical-ml/04-ensembles/03-gradient-boosting-negative-gradient/tests.py
"""
...
_module = load_solution(f"03-classical-ml/04-ensembles/{Path(__file__).resolve().parent.name}")
...
predict_regression_tree = load_solution(
    "03-classical-ml/03-decision-trees/05-regression-trees"

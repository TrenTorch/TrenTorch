"""
pytest data/app_data/03-classical-ml/04-ensembles/01-random-forest-majority-vote/tests.py
"""
...
random_forest_predict = load_solution(
    f"03-classical-ml/04-ensembles/{Path(__file__).resolve().parent.name}"

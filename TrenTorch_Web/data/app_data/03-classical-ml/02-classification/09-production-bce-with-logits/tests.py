"""
pytest data/03-classical-ml/02-classification/09-production-bce-with-logits/tests.py
"""
...
bce_with_logits_loss = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").bce_with_logits_loss

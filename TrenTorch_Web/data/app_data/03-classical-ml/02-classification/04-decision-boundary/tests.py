"""
pytest data/03-classical-ml/02-classification/04-decision-boundary/tests.py
"""
...
predict_labels = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").predict_labels

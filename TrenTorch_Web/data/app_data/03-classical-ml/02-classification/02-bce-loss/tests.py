"""
pytest data/03-classical-ml/02-classification/02-bce-loss/tests.py
"""
...
bce_loss = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").bce_loss

"""
pytest data/app_data/03-classical-ml/02-classification/05-training-loop/tests.py
"""
...
train_logistic_regression = load_solution(
    f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}"
...
bce_loss = load_solution("03-classical-ml/02-classification/02-bce-loss").bce_loss

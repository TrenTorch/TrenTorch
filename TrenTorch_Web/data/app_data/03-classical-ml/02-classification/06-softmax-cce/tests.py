"""
pytest data/03-classical-ml/02-classification/06-softmax-cce/tests.py
"""
...
_this = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}")

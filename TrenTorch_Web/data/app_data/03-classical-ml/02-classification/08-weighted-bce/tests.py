"""
pytest data/03-classical-ml/02-classification/08-weighted-bce/tests.py
"""
...
weighted_bce_loss = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").weighted_bce_loss

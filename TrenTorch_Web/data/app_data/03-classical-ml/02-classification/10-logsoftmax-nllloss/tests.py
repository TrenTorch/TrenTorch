"""
pytest data/app_data/03-classical-ml/02-classification/10-logsoftmax-nllloss/tests.py
"""
...
_module = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}")
log_softmax = _module.log_softmax
nll_loss = _module.nll_loss

_softmax_cce = load_solution("03-classical-ml/02-classification/06-softmax-cce")

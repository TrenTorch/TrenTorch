"""
pytest data/03-classical-ml/02-classification/01-sigmoid/tests.py
"""
...
sigmoid = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").sigmoid

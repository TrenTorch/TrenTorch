"""
pytest data/03-classical-ml/02-classification/07-lda/tests.py
"""
...
lda_fit = load_solution(f"03-classical-ml/02-classification/{Path(__file__).resolve().parent.name}").lda_fit
sigmoid = load_solution("03-classical-ml/02-classification/01-sigmoid").sigmoid
train_logistic_regression = load_solution("03-classical-ml/02-classification/05-training-loop").train_logistic_regression
predict_labels = load_solution("03-classical-ml/02-classification/04-decision-boundary").predict_labels

"""
pytest data/app_data/03-classical-ml/03-regularized-linear-models/02-ridge-regression/tests.py
"""
...
_module = load_solution(
    f"03-classical-ml/03-regularized-linear-models/{Path(__file__).resolve().parent.name}"
)
ridge_regression_closed_form = _module.ridge_regression_closed_form

closed_form_linear_regression = load_solution(
    "03-classical-ml/03-regularized-linear-models/01-normal-equation"

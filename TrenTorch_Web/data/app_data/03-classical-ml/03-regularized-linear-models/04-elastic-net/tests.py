"""
pytest data/app_data/03-classical-ml/03-regularized-linear-models/04-elastic-net/tests.py
"""
...
lasso_regression_coordinate_descent = load_solution(
    "03-classical-ml/03-regularized-linear-models/03-lasso-regression"

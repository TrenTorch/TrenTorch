"""
pytest data/app_data/03-classical-ml/06-unsupervised/02-kmeans-centroid-update/tests.py
"""
...
kmeans_update_centroids = load_solution(
    f"03-classical-ml/06-unsupervised/{Path(__file__).resolve().parent.name}"
...
def test_one_full_iteration_moves_centroids_toward_true_cluster_centers():
    ...
    load_kmeans_assign = load_solution(
        "03-classical-ml/06-unsupervised/01-kmeans-assignment"
    ).kmeans_assign

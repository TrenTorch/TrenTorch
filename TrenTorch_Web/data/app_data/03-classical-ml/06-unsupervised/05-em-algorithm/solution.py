...
gaussian_log_likelihood = load_solution(
    "03-classical-ml/05-instance-based-probabilistic/03-gaussian-naive-bayes"
).gaussian_log_likelihood
gmm_e_step = load_solution("03-classical-ml/06-unsupervised/04-gaussian-mixture").gmm_e_step
gmm_m_step = load_solution("03-classical-ml/06-unsupervised/04-gaussian-mixture").gmm_m_step

"""
pytest data/app_data/03-classical-ml/06-unsupervised/08-hierarchical-clustering/tests.py
"""
...
_module = load_solution(f"03-classical-ml/06-unsupervised/{Path(__file__).resolve().parent.name}")

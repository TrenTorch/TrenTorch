"""
pytest data/app_data/03-classical-ml/01-linear-regression/06-ridge-regularization/tests.py
"""
...
ridge_grad = load_solution(
    f"03-classical-ml/01-linear-regression/{Path(__file__).resolve().parent.name}"
).ridge_grad
mse_loss = load_solution("03-classical-ml/01-linear-regression/02-mse-loss").mse_loss
mse_gradient = load_solution("03-classical-ml/01-linear-regression/03-mse-gradient").mse_gradient
gd_step = load_solution("03-classical-ml/01-linear-regression/04-gd-step").gd_step

"""
pytest data/app_data/03-classical-ml/01-linear-regression/10-generalization-train-val-split/tests.py
"""
...
_module = load_solution(f"03-classical-ml/01-linear-regression/{Path(__file__).resolve().parent.name}")
...
train_linear_regression = load_solution(
    "03-classical-ml/01-linear-regression/05-training-loop"

"""
pytest data/app_data/03-classical-ml/04-support-vector-machines/03-linear-svm-gradient-descent/tests.py
"""
...
_module = load_solution(f"03-classical-ml/04-support-vector-machines/{Path(__file__).resolve().parent.name}")

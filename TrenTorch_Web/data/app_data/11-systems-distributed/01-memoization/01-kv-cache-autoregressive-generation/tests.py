"""
pytest data/app_data/11-systems-distributed/01-memoization/01-kv-cache-autoregressive-generation/tests.py
"""
...
_module = load_solution(f"11-systems-distributed/01-memoization/{Path(__file__).resolve().parent.name}")
...
autoregressive_decode_with_cache = load_solution(
    "08-inference/02-kv-cache-and-decoding/02-autoregressive-decoding-kv-cache"

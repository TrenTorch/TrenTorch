"""
pytest data/app_data/11-systems-distributed/01-memoization/02-benchmark-with-vs-without-cache/tests.py
"""
...
def test_10_matches_the_real_measured_generate_without_cache_work_pattern():
    ...
    kv_cache_module = load_solution(
        "11-systems-distributed/01-memoization/01-kv-cache-autoregressive-generation"
    )
    import numpy as np

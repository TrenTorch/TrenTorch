"""
pytest data/app_data/11-systems-distributed/02-parallelism/03-dataparallel-vs-distributeddataparallel/tests.py
"""
...
_module = load_solution(f"11-systems-distributed/02-parallelism/{Path(__file__).resolve().parent.name}")

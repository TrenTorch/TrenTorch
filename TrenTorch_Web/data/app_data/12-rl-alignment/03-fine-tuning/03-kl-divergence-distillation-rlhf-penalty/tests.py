"""
pytest data/app_data/12-rl-alignment/03-fine-tuning/03-kl-divergence-distillation-rlhf-penalty/tests.py
"""
...
_module = load_solution(f"12-rl-alignment/03-fine-tuning/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/12-rl-alignment/02-post-training-alignment/01-supervised-fine-tuning-response-loss-mask/tests.py
"""
...
_module = load_solution(f"12-rl-alignment/02-post-training-alignment/{Path(__file__).resolve().parent.name}")

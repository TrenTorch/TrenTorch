"""
pytest data/app_data/12-rl-alignment/04-benchmarking-and-capstone/02-apply-optimization-measure-improvement/tests.py
"""
...
_module = load_solution(f"12-rl-alignment/04-benchmarking-and-capstone/{Path(__file__).resolve().parent.name}")

...
matmul_from_scratch = load_solution("02-math-and-statistics/01-linear-algebra/03-matrix-multiplication").matmul_from_scratch
time_function = load_solution("12-rl-alignment/04-benchmarking-and-capstone/01-benchmark-harness").time_function
benchmark_statistics = load_solution(
    "12-rl-alignment/04-benchmarking-and-capstone/01-benchmark-harness"

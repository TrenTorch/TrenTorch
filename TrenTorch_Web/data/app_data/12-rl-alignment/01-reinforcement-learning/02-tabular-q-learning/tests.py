"""
pytest data/app_data/12-rl-alignment/01-reinforcement-learning/02-tabular-q-learning/tests.py
"""
...
_module = load_solution(f"12-rl-alignment/01-reinforcement-learning/{Path(__file__).resolve().parent.name}")
...
value_iteration = load_solution("12-rl-alignment/01-reinforcement-learning/01-value-iteration-mdp").value_iteration

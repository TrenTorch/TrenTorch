"""
pytest data/app_data/08-inference/03-quantization-and-numerical-efficiency/02-per-channel-weight-quantization/tests.py
"""
...
quantize_int8_per_channel = load_solution(
    f"08-inference/03-quantization-and-numerical-efficiency/{Path(__file__).resolve().parent.name}"
).quantize_int8_per_channel
quantize_int8_symmetric = load_solution(
    "08-inference/03-quantization-and-numerical-efficiency/01-symmetric-int8-quantization"

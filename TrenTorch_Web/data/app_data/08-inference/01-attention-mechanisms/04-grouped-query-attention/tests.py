"""
pytest data/app_data/08-inference/01-attention-mechanisms/04-grouped-query-attention/tests.py
"""
...
grouped_query_attention = load_solution(
    f"08-inference/01-attention-mechanisms/{Path(__file__).resolve().parent.name}"
).grouped_query_attention
multi_head_attention = load_solution(
    "08-inference/01-attention-mechanisms/02-multi-head-attention"
).multi_head_attention
multi_query_attention = load_solution(
    "08-inference/01-attention-mechanisms/03-multi-query-attention"

"""
pytest data/app_data/08-inference/02-kv-cache-and-decoding/01-rotary-position-embeddings-decoding/tests.py
"""
...
apply_rope = load_solution(
    f"08-inference/02-kv-cache-and-decoding/{Path(__file__).resolve().parent.name}"
).apply_rope

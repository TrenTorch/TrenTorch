"""
pytest data/app_data/08-inference/02-kv-cache-and-decoding/05-prefix-cache-lookup-reuse/tests.py
"""
...
_module = load_solution(f"08-inference/02-kv-cache-and-decoding/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/08-inference/04-batching-and-serving-metrics/02-serving-metrics-ttft-tpot-itl/tests.py
"""
...
serving_metrics = load_solution(
    f"08-inference/04-batching-and-serving-metrics/{Path(__file__).resolve().parent.name}"
).serving_metrics

"""
pytest data/app_data/05-dl-training/05-why-deep-networks-work/05-overparameterization-double-descent/tests.py
"""
...
_module = load_solution(f"05-dl-training/05-why-deep-networks-work/{Path(__file__).resolve().parent.name}")

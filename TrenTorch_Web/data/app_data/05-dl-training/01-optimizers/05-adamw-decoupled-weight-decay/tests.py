"""
pytest data/app_data/05-dl-training/01-optimizers/05-adamw-decoupled-weight-decay/tests.py
"""
...
_module = load_solution(f"05-dl-training/01-optimizers/{Path(__file__).resolve().parent.name}")
...
def test_adamw_with_zero_weight_decay_matches_plain_adam():
    adam_step = load_solution("05-dl-training/01-optimizers/04-adam-full-update").adam_step

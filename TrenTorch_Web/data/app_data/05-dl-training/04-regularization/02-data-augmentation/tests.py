"""
pytest data/app_data/05-dl-training/04-regularization/02-data-augmentation/tests.py
"""
...
_module = load_solution(f"05-dl-training/04-regularization/{Path(__file__).resolve().parent.name}")

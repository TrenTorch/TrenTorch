"""
pytest data/app_data/05-dl-training/03-training-loop/02-assemble-training-loop/tests.py
"""
...
_module = load_solution(f"05-dl-training/03-training-loop/{Path(__file__).resolve().parent.name}")
mse_loss_and_grad = _module.mse_loss_and_grad
train_one_epoch = _module.train_one_epoch

DL = load_solution("05-dl-training/03-training-loop/01-dataset-dataloader")

"""
pytest data/app_data/05-dl-training/02-layers/06-sequential-container/tests.py
"""
...
_module = load_solution(f"05-dl-training/02-layers/{Path(__file__).resolve().parent.name}")
Sequential = _module.Sequential
Module = load_solution("05-dl-training/02-layers/05-module-base-class").Module

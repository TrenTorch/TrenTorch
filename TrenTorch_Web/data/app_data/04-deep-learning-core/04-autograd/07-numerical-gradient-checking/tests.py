"""
pytest data/app_data/04-deep-learning-core/04-autograd/07-numerical-gradient-checking/tests.py
"""
...
_module = load_solution(f"04-deep-learning-core/04-autograd/{Path(__file__).resolve().parent.name}")
numerical_gradient = _module.numerical_gradient
relative_error = _module.relative_error
gradient_check = _module.gradient_check

Value = load_solution("04-deep-learning-core/04-autograd/04-graph-node").Value
backward = load_solution("04-deep-learning-core/04-autograd/06-minimal-autograd-engine").backward

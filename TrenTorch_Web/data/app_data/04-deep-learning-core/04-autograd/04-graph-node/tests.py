"""
pytest data/app_data/04-deep-learning-core/04-autograd/04-graph-node/tests.py
"""
...
Value = load_solution(f"04-deep-learning-core/04-autograd/{Path(__file__).resolve().parent.name}").Value

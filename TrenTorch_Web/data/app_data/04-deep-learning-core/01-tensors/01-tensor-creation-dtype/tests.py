"""
pytest data/app_data/04-deep-learning-core/01-tensors/01-tensor-creation-dtype/tests.py
"""
...
_module = load_solution(f"04-deep-learning-core/01-tensors/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/04-deep-learning-core/01-tensors/03-broadcasting-rules/tests.py
"""
...
broadcast_shapes = load_solution(
    f"04-deep-learning-core/01-tensors/{Path(__file__).resolve().parent.name}"
).broadcast_shapes

"""
pytest data/app_data/04-deep-learning-core/01-tensors/04-matmul/tests.py
"""
...
matmul = load_solution(f"04-deep-learning-core/01-tensors/{Path(__file__).resolve().parent.name}").matmul

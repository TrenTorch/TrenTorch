"""
pytest data/app_data/04-deep-learning-core/03-losses/03-binary-cross-entropy/tests.py
"""
...
_module = load_solution(f"04-deep-learning-core/03-losses/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/04-deep-learning-core/02-activations/07-leaky-relu/tests.py
"""
...
_module = load_solution(f"04-deep-learning-core/02-activations/{Path(__file__).resolve().parent.name}")

"""
pytest data/app_data/06-seq-modeling/01-tokenization/05-encode-decode-roundtrip/tests.py
"""
...
_module = load_solution(f"06-seq-modeling/01-tokenization/{Path(__file__).resolve().parent.name}")
encode = _module.encode
build_inverse_vocab = _module.build_inverse_vocab
decode = _module.decode

_build_vocabulary = load_solution(
    "06-seq-modeling/01-tokenization/02-vocabulary-building"
).build_vocabulary

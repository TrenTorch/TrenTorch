"""
pytest data/app_data/06-seq-modeling/02-embeddings/05-combine-token-positional-embeddings/tests.py
"""
...
_module = load_solution(f"06-seq-modeling/02-embeddings/{Path(__file__).resolve().parent.name}")

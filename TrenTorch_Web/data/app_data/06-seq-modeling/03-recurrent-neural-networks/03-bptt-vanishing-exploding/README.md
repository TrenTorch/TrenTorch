...
- `weight_hh` must be reused, UNCHANGED, at every single step (unlike `[05-dl-training/05-why-deep-networks-work/03-vanishing-exploding-gradients]`'s `matrix_gradient_norms`, which deliberately drew a FRESH random matrix per layer).

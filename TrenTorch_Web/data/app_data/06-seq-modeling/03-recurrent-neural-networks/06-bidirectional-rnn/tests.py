"""
pytest data/app_data/06-seq-modeling/03-recurrent-neural-networks/06-bidirectional-rnn/tests.py
"""
...
_module = load_solution(f"06-seq-modeling/03-recurrent-neural-networks/{Path(__file__).resolve().parent.name}")
...
def test_first_half_of_last_dim_is_the_forward_direction():
    ...
    rnn_cell_forward = load_solution(
        "06-seq-modeling/03-recurrent-neural-networks/01-rnn-cell-forward"
    ).rnn_cell_forward
    h_fwd = h0
    expected_fwd = []

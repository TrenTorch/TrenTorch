"""
pytest data/app_data/06-seq-modeling/04-attention/02-causal-mask/tests.py
"""
...
def test_composed_with_attention_a_position_never_attends_to_the_future():
    attn_module = load_solution("06-seq-modeling/04-attention/01-scaled-dot-product-attention")

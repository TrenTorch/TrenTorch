"""
pytest data/app_data/07-transformers-llm/03-language-model-assembly/03-next-token-cross-entropy/tests.py
"""
...
cross_entropy_forward = load_solution("04-deep-learning-core/03-losses/02-cross-entropy").cross_entropy_forward

...
softmax_last_axis = load_solution("06-seq-modeling/04-attention/03-softmax-last-axis").softmax_last_axis
...
def sample_next_token(logits_row: np.ndarray, temperature: float, top_k: int | None, rng: np.random.RandomState) -> int:
    ...
    distribution via `[06-seq-modeling/04-attention/03-softmax-last-axis]`'s

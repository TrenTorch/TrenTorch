...
- The weight update is `output_weight - lr * grad_output_weight`, ordinary SGD, exactly `[05-dl-training/03-training-loop/02-assemble-training-loop]`'s update rule.

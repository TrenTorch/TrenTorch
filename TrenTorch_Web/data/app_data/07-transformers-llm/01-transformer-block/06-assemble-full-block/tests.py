"""
pytest data/app_data/07-transformers-llm/01-transformer-block/06-assemble-full-block/tests.py
"""
...
_module = load_solution(f"07-transformers-llm/01-transformer-block/{Path(__file__).resolve().parent.name}")

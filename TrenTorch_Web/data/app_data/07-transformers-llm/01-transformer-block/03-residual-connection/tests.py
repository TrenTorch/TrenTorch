"""
pytest data/app_data/07-transformers-llm/01-transformer-block/03-residual-connection/tests.py
"""
...
def test_gradient_norm_does_not_shrink_across_many_stacked_residual_additions():
    # Contrast with 06-seq-modeling/03-recurrent-neural-networks/03-bptt-vanishing-exploding:

"""
pytest data/app_data/07-transformers-llm/01-transformer-block/05-swiglu-ffn/tests.py
"""
...
swish_forward = load_solution("04-deep-learning-core/02-activations/06-swish").swish_forward

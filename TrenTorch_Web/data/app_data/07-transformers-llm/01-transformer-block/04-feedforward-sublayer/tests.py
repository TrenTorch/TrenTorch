"""
pytest data/app_data/07-transformers-llm/01-transformer-block/04-feedforward-sublayer/tests.py
"""
...
linear_forward = load_solution("05-dl-training/02-layers/01-linear-forward").linear_forward
gelu_forward = load_solution("04-deep-learning-core/02-activations/05-gelu").gelu_forward

"""
pytest data/app_data/07-transformers-llm/02-modern-transformer-architecture/02-pre-norm-vs-post-norm/tests.py
"""
...
_module = load_solution(
    f"07-transformers-llm/02-modern-transformer-architecture/{Path(__file__).resolve().parent.name}"
)

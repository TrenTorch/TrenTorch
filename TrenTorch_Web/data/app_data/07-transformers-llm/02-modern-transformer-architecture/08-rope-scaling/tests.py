"""
pytest data/app_data/07-transformers-llm/02-modern-transformer-architecture/08-rope-scaling/tests.py
"""
...
_rope_module = load_solution("06-seq-modeling/02-embeddings/06-rope")
...
def test_relative_position_dot_product_invariance_is_preserved_after_scaling():
    # Directly mirrors 06-seq-modeling/02-embeddings/06-rope's own

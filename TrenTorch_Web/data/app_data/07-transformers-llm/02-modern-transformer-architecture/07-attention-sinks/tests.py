"""
pytest data/app_data/07-transformers-llm/02-modern-transformer-architecture/07-attention-sinks/tests.py
"""
...
build_sliding_window_mask = load_solution(
    "07-transformers-llm/02-modern-transformer-architecture/05-sliding-window-attention"

"""
pytest data/app_data/07-transformers-llm/02-modern-transformer-architecture/04-flash-attention/tests.py
"""
...
scaled_dot_product_attention = load_solution(
    "06-seq-modeling/04-attention/01-scaled-dot-product-attention"

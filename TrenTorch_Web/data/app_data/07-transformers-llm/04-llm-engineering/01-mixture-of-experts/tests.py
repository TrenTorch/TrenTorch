"""
pytest data/app_data/07-transformers-llm/04-llm-engineering/01-mixture-of-experts/tests.py
"""
...
_module = load_solution(f"07-transformers-llm/04-llm-engineering/{Path(__file__).resolve().parent.name}")

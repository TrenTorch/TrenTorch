//#region data/questions.ts
function slugify(title) {
	return title.toLowerCase().replace(/[()/]/g, "").replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "");
}
function mkTrack(name, topics, items) {
	return {
		name,
...
var curriculum = [
	{
		...
		tracks: [
			mkTrack("Linear Algebra", ["Linear Algebra"], [
				[
			...
			mkTrack("Probability", ["Probability & Statistics"], [
				[
			...
			mkTrack("Information Theory", ["Information Theory"], [
				[
	...
	},
	{
		...
		tracks: [
			mkTrack("Data Preprocessing", ["Data Processing"], [
				[
			...
			mkTrack("Exploratory Data Analysis", ["Data Processing"], [
				[
			...
			mkTrack("Statistical Inference", ["Probability & Statistics"], [
				[
	...
	},
	{
		...
		tracks: [
			...
			mkTrack("Regularized Linear Models", ["Regression", "Classic ML"], [
				...
				["Note: Generalized Linear Models, one framework behind Linear and Logistic Regression", "Easy"]
			]),
		...
		tracks: [
			...
			mkTrack("Instance-Based and Probabilistic", ["Classic ML"], [
				[
					...
					"Easy",
					"instance-based-probabilistic-knn"
				],
				[
				...
				[
					...
					"Easy",
					"instance-based-probabilistic-nearest-centroid"
				],
				[
		...
		tracks: [
			mkTrack("Unsupervised", ["Classic ML"], [
				[
					...
					"Easy",
					"unsupervised-kmeans-assignment"
				],
				[
					"K-Means: centroid update",
					"Easy",
					"unsupervised-kmeans-centroid-update"
				],
				[
					"PCA: projection",
					"Medium",
			...
			mkTrack("Evaluation and Model Selection", ["Metrics & Evaluation"], [
				...
				[
					"Random search, contrasted against grid search",
					"Medium",
	...
	},
	{
		...
		tracks: [
			mkTrack("Tensors", ["Linear Algebra"], [
				[
					"Tensor creation / dtype",
					"Easy",
					"dl-core-tensor-creation-dtype"
				],
				[
					"Elementwise ops",
					"Easy",
					"dl-core-elementwise-ops"
				],
				[
					"Broadcasting rules",
					"Medium",
					"dl-core-broadcasting-rules"
				],
				[
					"Matmul",
					"Medium",
				...
				[
					"Reshape / transpose",
					"Easy",
					"dl-core-reshape-transpose"
				],
				[
					"Reduction ops (sum, mean, max)",
					"Easy",
					"dl-core-reduction-ops"
				],
				[
					"Indexing / slicing",
					"Easy",
					"dl-core-indexing-slicing"
				]
			]),
			...
			mkTrack("Loss Functions", ["Loss Functions"], [
				...
				[
					"Cross-Entropy",
					"Medium",
					"dl-core-cross-entropy-loss"
				],
				[
					"Binary Cross-Entropy",
					"Medium",
					"dl-core-binary-cross-entropy-loss"
				]
			]),
			mkTrack("Autograd (micrograd-style progressive build)", ["Neural Networks"], [
				[
					...
					"Easy",
					"dl-core-backward-addition"
				],
				[
					"Backward for multiplication",
					"Easy",
					"dl-core-backward-multiplication"
				],
				[
					"Backward for matmul",
					"Medium",
					"dl-core-backward-matmul"
				],
				[
					"Graph node (value + grad + backward fn)",
					"Medium",
					"dl-core-graph-node"
				],
				[
					...
					"Hard",
					"dl-core-topological-sort"
				],
				[
					"Assemble minimal autograd engine",
					"Hard",
					"dl-core-minimal-autograd-engine"
				],
				[
		...
		tracks: [
			mkTrack("Optimizers", ["Optimization"], [
				...
				[
					"SGD + Momentum",
					"Medium",
					"dl-training-sgd-momentum"
				],
				[
					"Adam: bias-corrected moment estimates",
					"Medium",
					"dl-training-adam-bias-correction"
				],
				[
					"Adam: full update rule",
					"Medium",
					"dl-training-adam-full-update"
				],
				[
					"AdamW: decoupled weight decay",
					"Medium",
					"dl-training-adamw-decoupled-weight-decay"
				],
				[
					"Muon",
					"Hard",
			...
			mkTrack("Layers", ["Neural Networks"], [
				[
					"Linear fwd",
					"Easy",
					"dl-training-linear-forward"
				],
				[
					"Linear bwd",
					"Medium",
					"dl-training-linear-backward"
				],
				[
					"Dropout fwd/bwd",
					"Easy",
			...
			mkTrack("Training Loop", ["Neural Networks", "Data Processing"], [
				...
				[
					...
					"Easy",
					"dl-training-train-eval-mode"
				],
				[
					"Basic metric tracking (loss curve)",
					"Easy",
					"dl-training-metric-tracking"
				]
			]),
			mkTrack("Regularization", ["Neural Networks"], [
				[
			...
			mkTrack("Why Deep Networks Work", ["Neural Networks"], [
				[
				...
				["Note: optimization landscape vs. generalization, they are not the same problem", "Medium"],
				["Note: neural tangent kernel, an infinitely-wide network behaves like a fixed kernel", "Hard"],
	...
	},
	{
		...
		tracks: [
			mkTrack("Tokenization", ["NLP"], [
				[
					"Whitespace/character tokenizer",
					"Easy",
					"seq-tokenization-whitespace-char"
				],
				[
				...
				[
					"BPE: single merge step",
					"Medium",
					"seq-tokenization-bpe-single-merge"
				],
				[
					"Stretch: BPE, full training loop",
					"Hard",
					"seq-tokenization-bpe-full-training-loop"
				],
				[
					"Encode/decode round-trip",
					"Easy",
					"seq-tokenization-encode-decode-roundtrip"
				]
			]),
			mkTrack("Embeddings", ["NLP", "Transformers"], [
				[
					...
					"Easy",
					"seq-embeddings-token-embedding-lookup"
				],
				[
				...
				[
					...
					"Easy",
					"seq-embeddings-learned-positional-embedding"
				],
				[
			...
			mkTrack("Recurrent Neural Networks", ["NLP", "Neural Networks"], [
				[
					...
					"Easy",
					"seq-rnn-cell-forward"
				],
				[
					"Vanilla RNN cell, backward",
					"Medium",
					"seq-rnn-cell-backward"
				],
				[
				...
				[
					"LSTM cell, forward (gating mechanism)",
					"Medium",
					"seq-rnn-lstm-cell-forward"
				],
				[
					"GRU cell, forward (simplified gating)",
					"Medium",
					"seq-rnn-gru-cell-forward"
				],
				[
					"Stretch: bidirectional RNN",
					"Medium",
					"seq-rnn-bidirectional"
				],
				[
			...
			mkTrack("Attention", ["Transformers"], [
				[
					...
					"Medium",
					"seq-attention-scaled-dot-product"
				],
				[
					"Causal mask",
					"Easy",
					"seq-attention-causal-mask"
				],
				[
				...
				[
					"Stretch: Grouped-Query Attention (GQA)",
					"Hard",
					"seq-attention-grouped-query-attention"
				]
			])
		]
	},
		...
		tracks: [
			mkTrack("Transformer Block", ["Transformers"], [
				[
					...
					"Medium",
					"txf-block-layer-norm-forward"
				],
				[
					"Stretch: RMSNorm (alternative to LayerNorm)",
					"Easy",
					"txf-block-rmsnorm"
				],
				[
				...
				[
					"Stretch: SwiGLU-gated FFN",
					"Medium",
					"txf-block-swiglu-ffn"
				],
				[
				...
				[
					...
					"Medium",
					"txf-block-stack-blocks"
				]
			]),
			mkTrack("Modern Transformer Architecture", ["Transformers"], [
				[
				...
				[
					"Logit scaling before the final softmax",
					"Easy",
					"txf-modern-logit-scaling"
				]
			]),
			mkTrack("Language Model Assembly", ["Transformers", "NLP"], [
				[
					...
					"Easy",
					"txf-lm-output-projection"
				],
				[
					"Weight tying (share input/output embedding matrix)",
					"Medium",
					"txf-lm-weight-tying"
				],
				[
				...
				[
					...
					"Medium",
					"txf-lm-greedy-decoding"
				],
				[
					"Stretch: temperature + top-k sampling",
					"Medium",
					"txf-lm-temperature-topk-sampling"
				],
				[
					"Beam search decoding, contrasted against greedy",
					"Hard",
					"txf-lm-beam-search-decoding"
				]
			]),
			mkTrack("LLM Engineering", ["Transformers", "NLP"], [
				[
	...
	},
	{
		...
		tracks: [
			mkTrack("Convolutions", ["Computer Vision"], [
				...
				[
					"Stride: Skipping Positions to Downsample",
					"Easy",
					"vision-conv-stride"
				],
				[
					"Convolution over Multi-Channel Input",
					"Medium",
					"vision-conv-multi-channel"
				],
				[
					"Multiple Output Filters",
					"Medium",
					"vision-conv-multi-filter"
				],
				[
			...
			mkTrack("CNN Architecture", ["Computer Vision", "Neural Networks"], [
				[
					"Flatten: Bridging Convolutional and Linear Layers",
					"Easy",
					"vision-cnn-flatten"
				],
				[
				...
				[
					"Stacking Multiple CNN Blocks",
					"Medium",
					"vision-cnn-stack-blocks"
				],
				[
					"Full CNN Classifier",
					"Hard",
					"vision-cnn-full-classifier"
				]
			]),
			mkTrack("Modern CNN Concepts", ["Computer Vision", "Neural Networks"], [
				[
					"Batch Normalization",
					"Medium",
					"vision-modern-batchnorm"
				],
				[
					"Residual (Skip) Connection",
					"Medium",
					"vision-modern-residual-block"
				],
				[
					"1x1 Convolution (Bottleneck)",
					"Medium",
					"vision-modern-pointwise-conv"
				],
				[
					"Transposed Convolution",
					"Medium",
					"vision-modern-transposed-conv"
				],
				[
					"Depthwise-Separable Convolution",
					"Hard",
					"vision-modern-depthwise-separable"
				]
			]),
			mkTrack("CNN Architecture History", ["Computer Vision"], [
				[
				...
				[
					"VGG: Stacking Small 3x3 Convolutions",
					"Medium",
					"vision-history-vgg-stack"
				],
				[
			...
			mkTrack("Vision Transformer", ["Computer Vision", "Transformers"], [
				[
					"Patchify an Image into Fixed-Size Patches",
					"Medium",
					"vision-vit-patchify"
				],
				[
					"Patch Embedding",
					"Easy",
					"vision-vit-patch-embedding"
				],
				[
					"Class Token + Position Embedding",
					"Medium",
					"vision-vit-cls-position-embedding"
				],
				[
				...
				[
					"Classification Head",
					"Easy",
					"vision-vit-classification-head"
				],
				[
	...
	},
	{
		...
		tracks: [
			...
			mkTrack("Quantization", ["MLOps", "Neural Networks"], [
				[
					"Float32 to Int8 Mapping (Quantize)",
					"Medium",
			...
			mkTrack("Mixed Precision Training", ["MLOps", "Neural Networks"], [
				[
			...
			mkTrack("Compression", ["MLOps", "Neural Networks"], [
				[
					"Magnitude-Based Pruning, Single Step",
					"Medium",
	...
	},
	{
		...
		tracks: [mkTrack("Memoization", ["Transformers", "MLOps"], [
			[
	...
	},
	{
		...
		tracks: [
			mkTrack("Reinforcement Learning", ["Reinforcement Learning"], [[
				...
				"Tabular Q-learning",
				"Medium",
				"rl-alignment-tabular-q-learning"
			]]),
			mkTrack("Post-Training & Alignment", ["Reinforcement Learning", "NLP"], [
				[
			...
			mkTrack("Fine-tuning", ["Reinforcement Learning", "Neural Networks"], [
				...
				[
					...
					"Medium",
					"rl-alignment-policy-gradient-loss"
				],
				[
			...
			mkTrack("Benchmarking and Capstone", ["MLOps", "Metrics & Evaluation"], [
				...
				[
					"Final capstone: submission/report",
					"Hard",
					"rl-alignment-capstone-report"
				]
			])
		]
	},
	{
		...
		title: "Production ML",
		tracks: [
			mkTrack("Experiment Tracking & Versioning", ["MLOps"], [
				[
			...
			mkTrack("Deployment & Serving", ["MLOps"], [
				[
			...
			mkTrack("Monitoring & Drift", ["MLOps"], [
				[
	...
	},
	{
		...
		title: "Inference",
		tracks: [
			mkTrack("Attention Mechanisms", ["Transformers", "Inference"], [
				[
				...
				[
					"Multi-Head Attention: splitting into independent heads",
					"Medium",
					"inf-attn-multi-head"
				],
				[
			...
			mkTrack("KV Cache and Decoding", ["Transformers", "Inference"], [
				[
					"Rotary Position Embeddings at a single decode step",
					"Medium",
				...
				[
					"KV Cache Memory Footprint Across Attention Variants",
					"Easy",
					"inf-kv-memory-footprint"
				],
				[
					"PagedAttention Block Allocation (as used in vLLM)",
					"Hard",
					"inf-kv-paged-attention"
				],
				[
					"Prefix Cache Lookup and Reuse",
					"Medium",
					"inf-kv-prefix-cache"
				]
			]),
			mkTrack("Quantization and Numerical Efficiency", ["Inference", "MLOps"], [
				[
				...
				[
					"Block-Wise FP8 (E4M3-style) Quantization",
					"Hard",
					"inf-quant-fp8-blockwise"
				],
				[
					"Prefill and Decode Analysis with the Roofline Model",
					"Medium",
					"inf-quant-roofline"
				]
			]),
			mkTrack("Batching and Serving Metrics", ["Inference", "MLOps"], [
				[
					"Calculate P50, P95, and P99 Inference Latency",
					"Easy",
...
function getProgressStats(solvedSlugs = /* @__PURE__ */ new Set()) {
	const allSlugs = curriculum.flatMap((part) => part.tracks.flatMap((track) => track.questions.map((q) => q.slug)));
	return {
		completed: allSlugs.filter((slug) => solvedSlugs.has(slug)).length,
...
function getInProgressCount(solvedSlugs, attemptedSlugs) {
	return curriculum.flatMap((part) => part.tracks.flatMap((track) => track.questions.map((q) => q.slug))).filter((slug) => attemptedSlugs.has(slug) && !solvedSlugs.has(slug)).length;
}
function getPartProgress(solvedSlugs = /* @__PURE__ */ new Set()) {
...
function getDifficultyProgress(solvedSlugs = /* @__PURE__ */ new Set()) {
...
function findQuestionBySlug(slug) {
	for (const part of curriculum) for (const track of part.tracks) {
...
//#endregion
export { getPartProgress as a, getInProgressCount as i, findQuestionBySlug as n, getProgressStats as o, getDifficultyProgress as r, curriculum as t };

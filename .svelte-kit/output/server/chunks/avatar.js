...
import { C as getContext, Nt as ATTACHMENT_KEY, T as setContext, Wt as run, a as derived, d as spread_props, i as bind_props, l as props_id, r as attributes, w as hasContext } from "./server.js";
import { d as cn, u as createSubscriber } from "./solved.svelte.js";
...
function Avatar_image$1($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (child) {
			...
			child($$renderer, { props: mergedProps() });
			$$renderer.push(`<!---->`);
		} else $$renderer.push(`<!--[-1--><img${attributes({
			...mergedProps(),
			src
...
//#endregion
//#region platform/components/ui/avatar/avatar-fallback.svelte
...
//#endregion
//#region platform/components/ui/avatar/avatar-image.svelte
...
//#endregion
//#region platform/components/ui/avatar/avatar.svelte
...
//#endregion
export { cssToStyleObj as C, simpleBox as D, boxWith as E, executeCallbacks as S, boxFrom as T, ElementSize as _, boolToEmptyStrOrUndef as a, mergeProps as b, boolToTrueOrUndef as c, getDataTransitionAttrs as d, attachRef as f, Previous as g, getWindow as h, createId as i, createBitsAttrs as l, contains as m, Avatar_image as n, boolToStr as o, DOMContext as p, Avatar_fallback as r, boolToStrTrueOrUndef as s, Avatar as t, getDataOpenClosed as u, watch as v, composeHandlers as w, styleToString as x, Context as y };

...
class TestAutogradCore:
    ...
    def test_requires_grad_attribute(self):
        ...
        try:
            ...
            assert x.requires_grad, "requires_grad not set correctly"
            ...
            if hasattr(output, "backward"):
                try:
                    ...
                    if hasattr(layer, "weight") and layer.weight.grad is not None:
                        assert layer.weight.grad.shape == layer.weight.shape, "Weight gradient shape wrong"
            ...
            for batch_x, batch_y in dataloader:
                ...
                if hasattr(loss, "backward"):
                    try:
                        ...
                        if hasattr(layer, "weight") and layer.weight.grad is not None:
                            assert layer.weight.grad.shape == layer.weight.shape, "Batch gradient shape wrong"
                    except (TypeError, ValueError, AttributeError):
                        pass

...
class BPETokenizer(Tokenizer):
    ...
    def train(self, corpus: List[str], vocab_size: int = None) -> None:
        ...
        # training can learn merges that span a space character (e.g.
        # ('o', ' ')). Those merges can never fire at encode time, since
        # encode() operates on already-split words, which never contain a
        # space, wasting vocabulary capacity on dead merges.

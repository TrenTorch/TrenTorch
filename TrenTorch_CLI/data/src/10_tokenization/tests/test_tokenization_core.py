...
class TestTokenizerBasics:
    ...
    def test_tokenizer_encode(self):
        ...
        assert isinstance(token_ids, (list, np.ndarray)), "encode() should return list or array of IDs"
        assert all(isinstance(id, (int, np.integer)) for id in token_ids), "Token IDs should be integers"
    ...
    def test_vocabulary_size(self):
        ...
        assert isinstance(vocab_size, int) and vocab_size > 0, "Tokenizer should have positive vocab_size"

    ...
    try:
        ...
        try:
            ...
            try:
                ...
                results["tests"].append(
                    {"name": "dense_import", "status": "❌ FAIL", "description": f"Linear import failed: {e}"}
                )
        ...
        try:
            ...
            results["tests"].append(
                {"name": "dense_creation", "status": "❌ FAIL", "description": f"Linear creation failed: {e}"}
            )
            results["success"] = False
        ...
        try:
            ...
            results["tests"].append(
                {"name": "required_methods", "status": "❌ FAIL", "description": f"Method check failed: {e}"}
            )
            results["success"] = False

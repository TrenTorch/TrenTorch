...
class TestMilestoneImports:
    ...
    @pytest.mark.parametrize(
        "script", sorted(MILESTONES_DIR.rglob("*.py")), ids=lambda p: str(p.relative_to(MILESTONES_DIR))
    )
...
class TestModelConstruction:
    ...
    def test_milestone_01_perceptron(self):
        ...
        module = _import_milestone(MILESTONES_DIR / "01_1958_perceptron" / "01_rosenblatt_forward.py")
    ...
    def test_milestone_02_xor_crisis(self):
        ...
        module = _import_milestone(MILESTONES_DIR / "02_1969_xor" / "01_xor_crisis.py")
        assert module is not None

    def test_milestone_02_xor_solved(self):
        """Milestone 02 Part 2: XOR network constructs."""
        module = _import_milestone(MILESTONES_DIR / "02_1969_xor" / "02_xor_solved.py")
    ...
    def test_milestone_03_mlp(self):
        ...
        module = _import_milestone(MILESTONES_DIR / "03_1986_mlp" / "01_rumelhart_tinydigits.py")
    ...
    def test_milestone_04_cnn_tinydigits(self):
        ...
        module = _import_milestone(MILESTONES_DIR / "04_1998_cnn" / "01_lecun_tinydigits.py")
    ...
    def test_milestone_04_cnn_cifar(self):
        ...
        """
        module = _import_milestone(MILESTONES_DIR / "04_1998_cnn" / "02_lecun_cifar10.py")
    ...
    def test_milestone_05_transformer(self):
        ...
        module = _import_milestone(MILESTONES_DIR / "05_2017_transformer" / "01_vaswani_attention.py")
        assert module is not None

    def test_milestone_06_networks(self):
        """Milestone 06: All network classes in networks.py construct."""
        module = _import_milestone(MILESTONES_DIR / "06_2018_mlperf" / "networks.py")
        with patch("builtins.print"):
